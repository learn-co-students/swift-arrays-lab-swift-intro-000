...
for index in 0..<futureShoppingList.count
{
    if futureShoppingList[index] == "Cheese"
    {
...
let answer1 = lifesEssential(ingredients: ["Toast","Chops"])
...
let answer3 = lifesEssential(ingredients: shoppingList)
print (answer3)
...
let answer4 = lifesEssential(ingredients: dessertList)
print (answer4)
