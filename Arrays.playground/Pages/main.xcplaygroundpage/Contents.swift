 ...
 */
func lifeEssentials(ingredients: Array<String>) -> Bool {
 ...
 */
print(lifeEssentials(ingredients: shoppingList))
/*: question11
 ### 11. Pass the 'desertList' array to the 'lifesEssential' function and print the result.
 */
print(lifeEssentials(ingredients: dessertList))
