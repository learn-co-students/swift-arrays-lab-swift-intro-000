 ...
 */
let removedIndex = futureShoppingList.index(of: "Cheese")
futureShoppingList.remove(at: removedIndex!)
futureShoppingList.insert("Chicken", at: removedIndex!)
...
func lifesEssential(ingredients: [String]) -> Bool {
    switch ingredients.contains("Bread") && ingredients.index(of:"Bread") == 0 {
    case true:
        return true
    default:
        return false
 ...
 */
let doesContainBread = lifesEssential(ingredients: shoppingList)
print(doesContainBread)
 ...
 */
let doesContainBreadInDeserts = lifesEssential(ingredients: dessertList)
print(doesContainBreadInDeserts)
