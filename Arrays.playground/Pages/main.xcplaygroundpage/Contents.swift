 ...
 */
// write your code here
    let cheesSandwich :[String] = ["Bread", "Butter", "Cheese", "Lettuce", "Tomatoes"]
    print(cheesSandwich)
 ...
 */
// write your code here
    func lifeEssential(ingridient: [String]) -> Bool {
        if ingridient[0] == "Bread"{
            return true
        } else {
            return false
        }
    ...
    print(lifeEssential(ingridient: ["Bread", "Butter"]))
    print(lifeEssential(ingridient: ["Cheese", "Bread", "Butter"]))
 ...
 */
// write your code here
    print(lifeEssential(ingridient: shoppingList))

/*: question11
 ### 11. Pass the 'desertList' array to the 'lifesEssential' function and print the result.
 */
// write your code here
    print(lifeEssential(ingridient: dessertList))
