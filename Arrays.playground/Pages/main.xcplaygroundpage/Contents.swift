...
var shoppingList : [String] = ["Bread","Cheese","Lettuce","Tomatoes"]
...
var desserList = ["Cookie dough","Icecream"]
...
print(lifesEssential(ingredients: desserList))
