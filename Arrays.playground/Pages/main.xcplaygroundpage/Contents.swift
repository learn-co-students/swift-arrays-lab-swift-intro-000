 ...
 */
let cheeseSandwich = ["Bread", "Butter", "Butter", "Cheese", "Lettuce", "Tomatoes"]
 ...
 */
func lifesEssential(items: [String]) -> Bool{
    if items[0] == "Bread"{
        return true
    }
    else{
...
var items = ["Bread", "Cats"]
print(lifesEssential(items: items))
 ...
 */
print(lifesEssential(items: shoppingList))
 ...
 */
print(lifesEssential(items: dessertList))
