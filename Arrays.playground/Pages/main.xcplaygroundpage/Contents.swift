 ...
 */
func lifesEssential(list: [String]) -> Bool {
    if (list[0] == "Bread") {
        return true
    }
...
print(lifesEssential(list: futureShoppingList))
/*: question10
