...
var futurShoppingList:[String]

futurShoppingList = ["Bread","Butter","Cheese","Lettuce","Tomatoes"]
...
futurShoppingList[2] = "Chicken"
print(futurShoppingList)
