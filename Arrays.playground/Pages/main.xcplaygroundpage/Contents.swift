 ...
 */
var dessertList = ["Cookie Dough", "Ice Cream"]
/*: question6
...
// Look for a way to search within the array via the actual string rather than the index
// A method probably exists
/*: question9
...
// return true within the conditional is not working. Hardcoded return true for now, to refactor upon checking solution.
/*: question10
 ### 10. Pass the 'shoppingList' array to the 'lifesEssential' function and print the result.
 */
print(lifesEssential(array: shoppingList))
// returned true, because of the actual hardcoded return value outside of the conditional. Refactor this with #9
/*: question11
 ### 11. Pass the 'desertList' array to the 'lifesEssential' function and print the result.
 */
print(lifesEssential(array: dessertList))
// This one shoud return false. Refactor this along with #9 and #10