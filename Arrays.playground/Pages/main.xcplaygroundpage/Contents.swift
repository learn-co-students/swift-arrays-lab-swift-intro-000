 ...
 */
// write your code here
func lifesEssential(arr: Array<String>) -> Bool {
    return arr[0] == "Bread" ? true : false
}
lifesEssential(arr: ["Bread"])
lifesEssential(arr: ["Milk"])
...
print(lifesEssential(arr: shoppingList))
 ...
 */
// write your code here
print(lifesEssential(arr: desertList))
