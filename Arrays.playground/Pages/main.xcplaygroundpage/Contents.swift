...
var listLearnCo = ["Bread", "Butter", "Cheese", "Lettuce", "Tomatoes"]
...
var shoppingListLearnCo: [String] = ["Bread", "Butter", "Cheese", "Lettuce", "Tomatoes"]
...
var futureShoppingListLearnCo: [String]
futureShoppingList = ["Bread", "Butter", "Cheese", "Lettuce", "Tomatoes"]
...
let cheeseSandwichLearnCo: [String] = ["Bread", "Butter", "Cheese", "Lettuce", "Tomatoes"]




/*: question5
 ### 5. Create a second array called 'desertList' with a type specified which contains the string values "Cookie dough", "Icecream"
 */
var desertList: [String] = ["Cookie dough", "Icecream"]

var desertListLearnCo: Array<String> = ["Cookie dough", "Icecream"]
...
var afternoonAttendanceLearnCo: [Int] = [2, 10, 3, 15, 7]
 ...
 */
var itemToPrint = "Printed!"
shoppingList[1] = itemToPrint
print(itemToPrint)

let itemToPrintLearnCo = shoppingList[1]
print(itemToPrint)
