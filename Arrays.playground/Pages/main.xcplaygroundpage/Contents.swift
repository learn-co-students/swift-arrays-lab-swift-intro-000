...
lifeEssentials(ingredients: ["Bread", "Water"])
lifeEssentials(ingredients: ["Water", "Bread"])
 ...
 */
var shoppingListTest = lifeEssentials(ingredients: shoppingList)
print(shoppingListTest)
 ...
 */
var dessertListTest = lifeEssentials(ingredients: dessertList)
print(dessertListTest)
